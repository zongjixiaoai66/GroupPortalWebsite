...
var centerMenu = [
    {
        ...
        name: '集团文化留言',
        url: '../jituanwnehuaLiuyan/list.html'
    }
    ,{
        name: '集团文化收藏',
        url: '../jituanwnehuaCollection/list.html'
    }
    ,{
        name: '集团新闻留言',
        url: '../xinwenLiuyan/list.html'
    }
    ,{
        name: '集团新闻收藏',
        url: '../xinwenCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '集团文化',
        url: './pages/jituanwnehua/list.html'
    },
    {
        name: '公告通知',
    ...
    {
        name: '集团新闻',
        url: './pages/xinwen/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/jituanmenhu/admin/dist/index.html#/login";
