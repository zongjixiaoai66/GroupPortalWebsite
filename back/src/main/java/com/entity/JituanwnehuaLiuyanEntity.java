...
public class JituanwnehuaLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JituanwnehuaLiuyanEntity() {

	}

	public JituanwnehuaLiuyanEntity(T t) {
		try {
     ...
     * 集团文化
     */
    @ColumnInfo(comment="集团文化",type="int(11)")
    ...
    @TableField(value = "jituanwnehua_liuyan_text")
    ...
    public String toString() {
        return "JituanwnehuaLiuyan{" +
            ", id=" + id +
            ", jituanwnehuaId=" + jituanwnehuaId +
            ", yonghuId=" + yonghuId +
            ", jituanwnehuaLiuyanText=" + jituanwnehuaLiuyanText +
