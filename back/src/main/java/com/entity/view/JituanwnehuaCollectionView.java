...
public class JituanwnehuaCollectionView extends JituanwnehuaCollectionEntity implements Serializable {
	...
	*/
	...
	private String jituanwnehuaCollectionValue;
	...
	public JituanwnehuaCollectionView() {

	}

	public JituanwnehuaCollectionView(JituanwnehuaCollectionEntity jituanwnehuaCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jituanwnehuaCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getJituanwnehuaCollectionValue() {
		return jituanwnehuaCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setJituanwnehuaCollectionValue(String jituanwnehuaCollectionValue) {
		this.jituanwnehuaCollectionValue = jituanwnehuaCollectionValue;
	}
	...
	public String toString() {
		return "JituanwnehuaCollectionView{" +
			", jituanwnehuaCollectionValue=" + jituanwnehuaCollectionValue +
