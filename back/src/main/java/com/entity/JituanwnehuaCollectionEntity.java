...
public class JituanwnehuaCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JituanwnehuaCollectionEntity() {

	}

	public JituanwnehuaCollectionEntity(T t) {
		try {
